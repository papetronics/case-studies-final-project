...
The width of each layer (hidden size $d_h$) is 600 neurons, found through empirical hyperparameter tuning (and ablated in Section~\ref{sec:arch-ablations}).
...
This makes use of the upper bonus regression head described, which predicts the normalized final upper section score at the end of the episode:
