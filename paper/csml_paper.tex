...
\[
  a \sim \mathrm{Categorical}\!\left(\mathrm{softmax}\!\left(f_\theta(\phi(x))\right)\right)
\]
...
\subsubsection{Trunk}
The trunk of the network is a standard feedforward architecture with
2-3 fully connected hidden layers, each with 386-512 neurons.
We utilize layer normalization for improved training stability \cite{ba-2016-layernorm}
