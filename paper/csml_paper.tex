...
% 600-900 words
While on the surface \textit{Yahtzee} appears to be a trivial dice game, it actually presents large stochastic optimization problem
with combinatorial complexity. In this paper, we explore the application of various reinforcement learning techniques 
to optimize gameplay in \textit{Yahtzee}.
\subsection{Research Questions}
\subsection{Contributions}

\section{Related Work}
% 600-800 words
\subsection{Yahtzee and Combinatorial Game Reinforcement Learning}
\citet{verhoeff-1999-solitaire-yahtzee} showed that \textit{Yahtzee} can be analytically solved using dynamic programming techniques and provides baseline metrics from optimal play.
\citet{glenn-2007-solitaire-yahtzee} optimized the DP approach by taking advantage of symmetries and only considering reachable states. \citet{pawlewicz-2011-multiplayer-yahtzee}
extended the DP approach to 2-player \textit{Yahtzee}, however, the approach does not scale to more players due to the exponential growth of the state space.

Games with similar combinatorial complexity, such as \textit{Backgammon} \cite{tesauro-1995-td-gammon} and \textit{Poker} \cite{brown-2018-superhuman-poker},

\textit{Yahtzee} is also 
