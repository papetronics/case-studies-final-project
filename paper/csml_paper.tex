...
To monitor the quality of the value network, we monitor explained variance \cite{}.
To monitor for policy collapse, we track the policy entropy \cite{}, mask diversity \cite{}, the KL divergence between policy updates \cite{}, and the top-k action frequency \cite{}.
To monitor for learning stability, we track gradient norms and clip rate \cite{}.
To ensure advantages are well-conditioned, we track advantage mean and standard deviation \cite{}.
