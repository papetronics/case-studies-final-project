...
\subsubsection{TD}
Temporal Difference differs from REINFORCE by calculating the TD error. This uses an estimate of the value of the next state to bootstrap the return.
...
This allows for substantially larger batch sizes and learning rates.
