...
Swish and LayerNorm both improved stability and final performance, as shown in Figure~\ref{fig:silu-vs-relu} and Figure~\ref{fig:layernorm-learning}.
...
variance and credit assignment challenges; in fact,
it was difficult to return to the same level of performance we found with the single-turn agent. Performance immediately improved when we switched to TD(0) returns and A2C,
...
Fundamentally, the agent needs to learn to sacrifice the marginal points from the 5th dice in 4-of-a-kind, in order to keep itself in a better position to earn the bonus later.
