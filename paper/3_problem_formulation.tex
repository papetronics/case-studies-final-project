...
some dice, re-rolling the remaining ones. This can be repeated two more times, for a total of three total rolls.
After the final roll, the player must select one of the 13 scoring categories to apply to their current dice.
Each category can only be used once and has specific criteria and scoring rules.
