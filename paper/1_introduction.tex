...
Concretely, we ask: \begin{enumerate*}[label=(\roman*)]
    ...
    \item Which design choices (state and action encodings, credit assignment, variance controls, baselines, entropy, reward shaping, etc) most affect final performance?
