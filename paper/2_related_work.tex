...
Learning the value function over shorter horizons is a simpler problem than estimating the entire sequence of rewards, so in some environments, TD methods are more sample efficient than REINFORCE.
