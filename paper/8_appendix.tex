...
The custom gym environment, training code, models, and final evaluation statistics for this project are \href{https://github.com/papetronics/case-studies-final-project}{available on GitHub}.

Likewise, data for all experiments used in this graph is available in \href{https://wandb.ai/papetronics/pape-lab/reports/Case-Studies-Ablations--VmlldzoxNTE4NDMzOA}{this Weights \& Biases report}.
...
\begin{table}[H]
    ...
    \begin{tabular}{lccc}
        ...
        \hline
        $\alpha$                       & 0.001              & 0.0001       & 0.001        \\
        $r_{\alpha}$ (Min LR Ratio)    & 0.01               & 0.05         & 0.05         \\
        $\gamma$ (min)                 & 0.95               & 0.99         & 0.99         \\
        $\gamma$ (max)                 & 1.0                & 0.99         & 0.99         \\
        $\tau_{\mathrm{clip}}$         & 0.0                & 1.0          & 1.0          \\
        $\lambda_V$                    & 0.025              & 0.005        & 0.02         \\
        $\beta_{\mathrm{roll}}$ (max)  & 0.1                & 0.1          & 0.005        \\
        $\beta_{\mathrm{roll}}$ (min)  & 0.01               & 0.02         & 0.005        \\
        $\beta_{\mathrm{score}}$ (max) & 0.02               & 0.03         & 0.05         \\
        $\beta_{\mathrm{score}}$ (min) & 0.003              & 0.01         & 0.01         \\
        Entropy Hold Period            & 0.25               & 0.075        & 0.05         \\
        Entropy Anneal Period          & 0.91               & 0.9          & 0.9          \\
        \hline
    \end{tabular}
\end{table}
...
The total cost of cloud compute was approximately \textbf{\$223}.
Over \textbf{481} training runs were logged in Weights \& Biases, totaling approximately \textbf{1,310.73 GPU hours}.
